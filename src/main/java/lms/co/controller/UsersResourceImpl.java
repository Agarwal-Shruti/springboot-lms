            		...
            		&& book.getBorrower().equals("none"))
            		{
            			...
            			if(borroweruser.getBook1issue().equals("none"))
            				...
            				borroweruser.setBook3issue(book.getTitle());
            				 ...
            				 borroweruser.setStatus("You [user id ]"+userid +"have used total limit as only max 3 books can borrowed by per user");
        	 ...
        	 if(user.getUserid().equals(userid))
             		{
        		 		...
        		 		else if(user.getBook2issue().equals(borroweruser.getBook2issue()))
        		 			user.setBook2issue("none");
        		 		else if(user.getBook3issue().equals(borroweruser.getBook3issue()))
        		 			user.setBook3issue("none");
